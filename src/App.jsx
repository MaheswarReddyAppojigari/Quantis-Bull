...
// export default App;
import React from 'react';
import { TrendingUp, Bitcoin, DollarSign, MessageSquare, BarChart3, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <main className="max-w-7xl mx-auto px-6 py-16">
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center mb-20">
          <div className="space-y-6">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              Stay updated with the most relevant market information across stocks, cryptocurrency, and forex. Our platform gives you real-time insights, allowing you to make informed decisions quickly.
            </p>
            <p className="text-lg text-slate-600 leading-relaxed">
              Whether you're a novice investor or a seasoned trader, we have resources and tools designed for all levels. Our AI-powered chatbot is ready to assist you in navigating the platform and answering your market questions.
            </p>
          </div>
        ...
        <section className="space-y-8">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-slate-900 mb-3">Choose Your Market</h3>
            <p className="text-lg text-slate-600">Select a market to start exploring live data and insights</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {markets.map((market, index) => (
              ...
              >
                <div className={`absolute inset-0 bg-gradient-to-br ${market.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-300`}></div>
                
                <div className="relative p-8 space-y-4">
                  <div className={`inline-flex p-4 rounded-xl bg-gradient-to-br ${market.gradient} text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                    {market.icon}
                  </div>
        ...
        <section className="mt-20 bg-white rounded-3xl shadow-xl p-12">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="space-y-3">
              ...
              <h4 className="text-xl font-bold text-slate-900">Real-Time Data</h4>
              <p className="text-slate-600">Live updates on all major markets and assets</p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-slate-600">Comprehensive tools for market analysis</p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-slate-600">Get instant answers to your market questions</p>
            </div>
          </div>
        </section>
      </main>
      ...
      <footer className="bg-slate-900 text-slate-400 py-8 mt-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <p>© 2024 Quantis Bull. Making markets accessible for everyone.</p>
        </div>
      </footer>
    </div>
  );
